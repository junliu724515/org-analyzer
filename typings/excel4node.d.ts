declare module 'excel4node' {
  ...
  class Worksheet {
     ...
     */
    public addDataValidation(opt: WorksheetValidation): void;
    /**
     ...
     */
    public addConditionalFormattingRule(ref: string, opt: AddConditionalFormattingRuleOptions): void;

    public column(number: number): Column;

    public row(number: number): Row;
     ...
     */
    public cell(startRow: number, startColumn: number): Cell;
    // public cell(startRow: number, startColumn: number, endRow: number, endColumn: number): Cell;
    public cell(startRow: number, startColumn: number, endRow: number, endColumn: number, isMerged?: boolean): Cell;

    /**
     * Adds and image to the worksheet.
     */
    public addImage(opt: AddImageOptions): void;
  }
  /**
   * An instance of the Workbook class contains all data and parameters for the Excel Workbook.
   */
  export class Workbook {
    public constructor(opt?: WorkbookOption);
    /**
     * Add Worksheets to the workbook. Accepts name of new WorkSheet and options object.
     */
    // public addWorksheet(sheet: string): Worksheet;
    // public addWorksheet(opts?: WorksheetOption): Worksheet;
    public addWorksheet(sheet?: string, opts?: WorksheetOption): Worksheet;
    ...
    public write(filename: string, callback?: (err: never, stats: Stats) => void): void;
